...
double cof_surface_target[] = {3.5,4.1,6.0};
double cof_surface_alpha[] = {0.55,0.2,2.0};
...
double cof_contact_depth[] = {0.25,0.5,0.2};
double cof_contact_edge[n_cell_types][n_cell_types] = {{-19.0,-8.3,2.0},{-9.25,-19.5,2.0},{2.0,2.0,2.0}};
