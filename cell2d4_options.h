...
double cof_surface_target[] = {5.0,3.0,6.0};
double cof_surface_alpha[] = {0.6,0.4,3.0};
...
double cof_contact_medium[] = {0.0,1.0,1.0};
double cof_contact_depth[] = {0.2,0.2,0.2};
double cof_contact_edge[n_cell_types][n_cell_types] = {{-45.5,-12.0,-1.0},{-12.0,-14.5,0.5},{-1.0,0.0,-5.0}};
...
long int cof_divide_rate[] = {4000,-1,-1};