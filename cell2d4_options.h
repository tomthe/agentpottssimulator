...
double cof_volume_target[] = {2.5,1.0,2.0};
double cof_volume_alpha[] = {3.0,2.0,2.0};

int cof_surface_do_calc[] = {1,1,1,1};
double cof_surface_target[] = {10.0,6.0,6.0};
...
double cof_contact_intersection[n_cell_types][n_cell_types] = {{255.0,52.0,52.0},{52.0,52.0,52.0},{52.0,52.0,52.0}};
