...
double cof_volume_target[] = {8.0,1.3,2.0};
double cof_volume_alpha[] = {4.0,3.0,2.0};

int cof_surface_do_calc[] = {1,1,1};
double cof_surface_target[] = {12.0,12.1,6.0};
double cof_surface_alpha[] = {0.01,0.1,2.0};
...
double cof_contact_edge[n_cell_types][n_cell_types] = {{-4.0,-5.0,2.0},{-4.5,-5.5,2.0},{2.0,2.0,2.0}};
