...
double cof_move_step_size[] = {0.06,0.06,0.04,0.01};
...
double cof_volume_target[] = {5.0,3.0,4.5};
...
double cof_contact_alpha[] = {155.0,25.0,9.0};
double cof_contact_distance[] = {0.4,0.4,0.1};
double cof_contact_medium[] = {2.0,55.0,1.0};
double cof_contact_depth[] = {0.2,0.2,0.2};
double cof_contact_edge[n_cell_types][n_cell_types] = {{-45.5,-3.0,-1.0},{-3.0,-19.5,0.5},{-1.0,0.0,-5.0}};
double cof_contact_intersection[n_cell_types][n_cell_types] = {{10.0,10.0,52.0},{10.0,10.0,52.0},{52.0,52.0,52.0}};
