...
double cof_contact_medium[] = {2.0,10.0,1.0};
double cof_contact_depth[] = {0.2,0.2,0.2};
double cof_contact_edge[n_cell_types][n_cell_types] = {{-45.5,-3.0,-5.0},{-3.0,-19.5,-55},{0.0,0.0,0.0}};
double cof_contact_intersection[n_cell_types][n_cell_types] = {{10.0,10.0,50.0},{10.0,10.0,50.0},{52.0,52.0,52.0}};
